...
import CanvasTopPanel from "@/js/components/Panels/CanvasTopPanel.vue";
...
<template>
    ...
    <aside id="logo-sidebar"
        ...
        <div class="h-full p-3 overflow-y-auto bg-white dark:bg-gray-800">
            ...
            <div  class="flex flex-col pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                <button @click="()=>canvasStore.debug = !canvasStore.debug"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-5 w-5 h-5">
                ...
                <button v-if="canvasStore.debug" @click="canvasStore.initRandomElements" type="button" class="px-5 py-2.5 me-2 mb-2 text-sm text-gray-900 hover:text-blue-700 dark:text-gray-400 dark:hover:text-white font-medium bg-white hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 outline-none rounded-lg border border-gray-200 dark:border-gray-600">Regenerate Elements</button>
                <CanvasLeftPanel v-if="canvasStore.debug" />
            </div>
        </div>
    </aside>
</template>