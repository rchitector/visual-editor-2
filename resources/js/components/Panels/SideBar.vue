...
import DarkModeButton from "../Controls/DarkModeButton.vue";
...
<template>
    ...
    <aside id="logo-sidebar"
           ...
           aria-label="Sidebar">
        <div class="h-full flex flex-col p-3 overflow-y-auto bg-white dark:bg-gray-800">
            ...
            <ul class="space-y-2 font-medium">
                ...
                <!--                            <path d="M12.5 0c-.157 0-.311.01-.565.027A1 1 0 0 0 11 1.02V10h8.975a1 1 0 0 0 1-.935c.013-.188.028-.374.028-.565A8.51 8.51 0 0 0 12.5 0Z"/>-->
                <!--                        </svg>-->
                <!--                        <span class="ms-3">Bottom List Item</span>-->
                <!--                    </a>-->
                <!--                </li>-->
            </ul>
        </div>
