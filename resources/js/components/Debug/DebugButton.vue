...
<template>
    ...
    >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
             ...
             :class="canvasStore.debug ? 'fill-red-500 dark:fill-red-400' : 'fill-gray-500 dark:fill-gray-400'"
        >
        ...
        <div :class="canvasStore.debug ? 'text-red-500 dark:text-red-400' : 'text-gray-500 dark:text-gray-400'" class="ms-3">
            <span>Debug is</span>
            <div class="ml-2 inline-block w-8">{{
                    canvasStore.debug ? 'ON' : 'OFF'
                }}
            </div>
        </div>
    </button>
