...
<button
    ...
    <div bind:this={lightIcon}
         class="hidden flex items-center text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
