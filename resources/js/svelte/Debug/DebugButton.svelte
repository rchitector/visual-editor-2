<script lang="ts">
    import {debugStore, toggleDebug} from '@/js/svelte/Store/store';
</script>
...
<button onclick={toggleDebug}
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
         ...
         class:fill-red-500={$debugStore}
         class:dark:fill-red-400={$debugStore}
         class:fill-gray-500={!$debugStore}
         class:dark:fill-gray-400={!$debugStore}>
    ...
    <div class="ms-3"
         class:text-red-500={$debugStore}
         class:dark:text-red-400={$debugStore}
         class:text-gray-500={!$debugStore}
         class:dark:text-gray-400={!$debugStore}>
        <span>Debug is</span>
        <div class="inline-block w-7">{ $debugStore ? 'ON' : 'OFF' }</div>
    </div>
</button>
