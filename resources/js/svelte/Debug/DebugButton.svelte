<script>
    import {store, toggleDebug} from '@/js/svelte/Store/store';
</script>
...
<button onclick={toggleDebug}
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
         ...
         class:fill-red-500={$store.debug}
         class:dark:fill-red-400={$store.debug}
         class:fill-gray-500={!$store.debug}
         class:dark:fill-gray-400={!$store.debug}>
    ...
    <div class="ms-3"
         class:text-red-500={$store.debug}
         class:dark:text-red-400={$store.debug}
         class:text-gray-500={!$store.debug}
         class:dark:text-gray-400={!$store.debug}>
        <span>Debug is</span>
        <div class="inline-block w-7">{ $store.debug ? 'ON' : 'OFF' }</div>
    </div>
</button>
